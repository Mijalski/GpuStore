...
namespace Mijalski.GpuStore.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update GpuStoreDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update GpuStoreEfCoreEntityExtensionMappings to extend the IdentityUser entity
