...
{
    public partial class Created_GPU_Entity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RamSize = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    RamType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    DoesSupportRtx = table.Column<bool>(type: "bit", nullable: false),
                    MemoryBus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppGraphicsCards", x => x.Id);
                });
